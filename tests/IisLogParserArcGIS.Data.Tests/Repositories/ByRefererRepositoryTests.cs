...
public class ByRefererRepositoryTests
{
    [Fact]
    public void Insert_ThenGetByLocalDate_RoundTripsRows()
    {
        ...
        repository.Insert(
            connection,
            [
                new ByRefererAggregateRow { LocalDate = localDate, Referer = "https://example.com/", TimeTakenSecond = 1.5, Hits = 3 },
                new ByRefererAggregateRow { LocalDate = localDate, Referer = "-", TimeTakenSecond = 2.0, Hits = 4 },
            ]);
    ...
    public void DeleteByLocalDate_OnlyRemovesRowsForThatDate()
    {
        ...
        repository.Insert(
            connection,
            [
                new ByRefererAggregateRow { LocalDate = new DateOnly(2026, 5, 1), Referer = "https://example.com/", TimeTakenSecond = 1.0, Hits = 1 },
                new ByRefererAggregateRow { LocalDate = new DateOnly(2026, 5, 2), Referer = "https://example.com/", TimeTakenSecond = 1.0, Hits = 1 },
            ]);
